...
namespace CRUDloginSQLwithEntityFramework.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<ProductosActivo> ProductosActivos { get; set; } = null!;
        public virtual DbSet<ProductosDescontinuado> ProductosDescontinuados { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-H0G0MAA\\CAMILOROOTDB;Database=AdventureWorks2019;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductosActivo>(entity =>
            {
                ...
                entity.ToView("ProductosActivos");
                ...
                entity.Property(e => e.NombreSubCategoria).HasMaxLength(50);
            ...
            modelBuilder.Entity<ProductosDescontinuado>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductosDescontinuados");
